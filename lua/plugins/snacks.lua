...
return {
    ...
    opts = {
        ...
        explorer = {
            ...
            replace_netrw = false
        },                               -- False: Opens the folder in netrw. True: Opens the folder in snacks explorer
        ...
        animate = {
            enabled = false,         -- Disable animations for performance e.g. indent lining won't animate
            style = "out",
